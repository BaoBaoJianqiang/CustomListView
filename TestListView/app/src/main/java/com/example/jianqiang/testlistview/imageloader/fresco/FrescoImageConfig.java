...
public class FrescoImageConfig extends ImageConfig {
    ...
    private FrescoImageConfig(Buidler builder) {
        ...
        this.mBitmapListener = builder.mBitmapListener;
    }
    ...
    public static final class Buidler {
        ...
        private boolean dontAnimation;//是否取消动画
        private boolean isFitCenter;
        public BitmapListener mBitmapListener;

        public BitmapListener getBitmapListener() {
            return mBitmapListener;
        }

        public Buidler setBitmapListener(BitmapListener bitmapListener) {
